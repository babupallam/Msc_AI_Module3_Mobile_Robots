...
def main():
    ...
    if client_id != -1:
        ...
        # Begin FSM-style loop
        random_turn = random.uniform(0.5, 1.5)  # Random turn modifier for wandering
        ...
        try:
            while True:
                ...
                robot.drive(1.0)  # Move forward at constant speed
                if front_left <= 1:
                    robot.steer(-2.0, 2.0)
                    ...
                    robot.steer(random_turn - 1, random_turn + 1)
                    console_log("Action Taken", {
                        "Message": "Wandering with random turn.",
                        "Random Turn": (random_turn - 1, random_turn + 1)
                    })
